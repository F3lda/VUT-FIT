...
# Source:           https://github.com/LukasNevrkla/ID3-algorithm
# Auto-testSets:    @Matej
##################################
...
if __name__ == "__main__":
    ...
    for b in runBatches:
        print("Train set = examples [{0}, {1}]".format(b["trainSet"][0], b["trainSet"][1]-1))
        print("-" * 25)
        ...
        print("Test set = examples [{0}, {1}]".format(b["testSet"][0], b["testSet"][1]-1))
