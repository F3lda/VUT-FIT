...
int SemaphoreDestroy(int semaphoreId)
{
...
int SemaphorePushOperation(int semaphoreId, int operation)
{
	...
	sem_buf.sem_flg = 0;// flag - 0: wait until operation is done; IPC_NOWAIT: don't wait; SEM_UNDO - automatically undo when the process terminates
