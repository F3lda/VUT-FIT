# 
# Project automation script for proj 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source proj.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "clkgen.vhd"
   xfile add "clkgen_config.vhd"
   xfile add "fpga.vhd"
   xfile add "fpga_fitkit.ucf"
   xfile add "fpga_inst.vhd"
   xfile add "tlv_gp_ifc.vhd"

   # Set the Top Module as well...
   project set top "arch_gp_ifc" "fpga"
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/tools/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "/home/vojta/git/IVH/proj/proj_final_template/proj/fpga_fitkit.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "/home/vojta/git/IVH/proj/proj_final_template/proj/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "fpga" -process "Generate IBIS Model"
